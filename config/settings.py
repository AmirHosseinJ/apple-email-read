...
OUTLOOK_OTP_ATTEMPT_TIMEOUT_SECONDS = env_int('OUTLOOK_OTP_ATTEMPT_TIMEOUT_SECONDS', 10)
...
EMAIL_CHECK_WEBHOOK_TIMEOUT_SECONDS = env_int('EMAIL_CHECK_WEBHOOK_TIMEOUT_SECONDS', 3)
EMAIL_CHECK_WEBHOOK_TRY_COUNT = env_int('EMAIL_CHECK_WEBHOOK_TRY_COUNT', 3)
EMAIL_CHECK_WEBHOOK_RETRY_DELAY_SECONDS = env_int('EMAIL_CHECK_WEBHOOK_RETRY_DELAY_SECONDS', 1)
